...
from agentical.core.exceptions import TimeoutError, ExternalServiceError
...
class PerformanceMonitor:
    ...
    def record_request(self, response_time: float, status_code: int):
        ...
        with self._lock:
            ...
            # Update error rate
            if status_code >= 400:
                error_count = sum(1 for _ in self._request_times)  # Simplified for demo
    ...
    def get_performance_summary(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                "min_response_time": round(min(self._request_times), 3),
                "max_response_time": round(max(self._request_times), 3),
                "p95_response_time": round(self._calculate_percentile(95), 3),
                "p99_response_time": round(self._calculate_percentile(99), 3),
